...
- 考证：perf-analyzer 提交 `011f086` + 主仓库提交 `01b85c2`（双仓库实证，均 2026-09-10 18:58，ADR-019）；net-doctor 提交 `1f60f95`（19:57，ADR-013 已入档）；主仓库 `3069ea7`（20:00，GitLab 推送）、`d5fc4fa`（20:09，接口台账 SRV-070/078/079、BRG-050/051 更新，台账 151 条）；E2E 190/190、冒烟 72/72、v6 安装包 20:00 来源：会话记忆（2026-09-10）。
